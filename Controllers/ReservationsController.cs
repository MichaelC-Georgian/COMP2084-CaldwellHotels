...
namespace CaldwellHotels.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Reservations.Include(r => r.Persons).Include(r => r.Rooms);
        ...
        public async Task<IActionResult> Create([Bind("ReservationID,PersonID,RoomID,StartDate,EndDate")] Reservation reservation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReservationID,PersonID,RoomID,StartDate,EndDate")] Reservation reservation)
        {
